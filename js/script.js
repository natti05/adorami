...
var allCategoriesJson = "https://coursera-jhu-default-rtdb.firebaseio.com/categories.json";
...
ado.loadMenuItems = function (categoryShort) {
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
    menuItemsJson + categoryShort + ".json",
